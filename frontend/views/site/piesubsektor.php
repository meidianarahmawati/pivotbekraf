...
option = {
    ...
    legend: {
        ...
        bottom: 10,
        left: 'center',
        data: ['Kuliner', 'Fashion','Kriya','Penerbitan','Lainnya']
    },
    series : [
        {
            type: 'pie',
            ...
            data:[
                ...
                {value:535, name: 'Penerbitan'},
                {value:510, name: 'Kriya'},
                {value:634, name: 'Fashion'},
                {value:735, name: 'Kuliner'}
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
