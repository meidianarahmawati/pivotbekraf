    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">            
			...
			<script type="text/javascript">
				...
				var labelSetting2016 = {
				    normal: {
				        show: true,
				        position: 'outside',
				        offset: [0, -15],
				        formatter: function (param) {
				            return (param.value / 9425974 * 100).toFixed(0) + '%';
				        },
				        textStyle: {
				            fontSize: 18,
				            fontFamily: 'Arial'
				...
				var labelSetting2015 = {
				    normal: {
				        show: true,
				        position: 'outside',
				        offset: [0, -15],
				        formatter: function (param) {
				            return (param.value / 8566782 * 100).toFixed(0) + '%';
				        },
				        textStyle: {
				            fontSize: 18,
				            fontFamily: 'Arial'
				...
				var labelSetting2014 = {
				    normal: {
				        show: true,
				        position: 'outside',
				        offset: [0, -15],
				        formatter: function (param) {
				            return (param.value / 8187218 * 100).toFixed(0) + '%';
				        },
				        textStyle: {
				            fontSize: 18,
				            fontFamily: 'Arial'
				...
				var labelSetting2013 = {
				    normal: {
				        show: true,
				        position: 'outside',
				        offset: [0, -15],
				        formatter: function (param) {
				            return (param.value / 7859207 * 100).toFixed(0) + '%';
				        },
				        textStyle: {
				            fontSize: 18,
				            fontFamily: 'Arial'
				...
				var labelSetting2012 = {
				    normal: {
				        show: true,
				        position: 'outside',
				        offset: [0, -15],
				        formatter: function (param) {
				            return (param.value / 7810954 * 100).toFixed(0) + '%';
				        },
				        textStyle: {
				            fontSize: 18,
				            fontFamily: 'Arial'
				...
				var labelSetting2011 = {
				    normal: {
				        show: true,
				        position: 'outside',
				        offset: [0, -15],
				        formatter: function (param) {
				            return (param.value / 7036605 * 100).toFixed(0) + '%';
				        },
				        textStyle: {
				            fontSize: 18,
				            fontFamily: 'Arial'
				...
				option = {					
						title: {
							text : 'Jumlah Tenaga Kerja Wanita di Sektor Ekonomi Kreatif',
					        subtext: 'Berdasarkan Kelompok Umur'
					    },
					    tooltip: {
					    },
					    legend: {
					    ...
					    xAxis: {
					        ...
					        <?php
							    $i=0;
								foreach($data2016["kelompokumur"] as $iname){
									echo "'".$iname."',";
									$i++;
								}
							?>
					    ...
					    series: [
					    {
					        ...
					        label: labelSetting2011,
					        data: 
					        [
					        <?php
						    $i=0;
							foreach($data2011["kelompokumur"] as $iname){
								echo "{value: ".$data2011["jml"][$i].",";
					        ...
					        symbolClip: true,
					        symbolBoundingData: bodyMax,
					        label: labelSetting2012,
					        data: 
					        [
					        <?php
						    $i=0;
							foreach($data2012["kelompokumur"] as $iname){
								echo "{value: ".$data2012["jml"][$i].",";
								echo "symbol: symbols[".$i."],},";
								$i++;
							}
							?>
					        ...
					        symbolClip: true,
					        symbolBoundingData: bodyMax,
					        label: labelSetting2013,
					        data: 
					        [
					        <?php
						    $i=0;
							foreach($data2013["kelompokumur"] as $iname){
								echo "{value: ".$data2013["jml"][$i].",";
								echo "symbol: symbols[".$i."],},";
								$i++;
							}
							?>
					        ...
					        symbolClip: true,
					        symbolBoundingData: bodyMax,
					        label: labelSetting2014,
					        data: 
					        [
					        <?php
						    $i=0;
							foreach($data2014["kelompokumur"] as $iname){
								echo "{value: ".$data2014["jml"][$i].",";
								echo "symbol: symbols[".$i."],},";
								$i++;
							}
							?>
					        ...
					        symbolClip: true,
					        symbolBoundingData: bodyMax,
					        label: labelSetting2015,
					        data: 
					        [
					        <?php
						    $i=0;
							foreach($data2015["kelompokumur"] as $iname){
								echo "{value: ".$data2015["jml"][$i].",";
								echo "symbol: symbols[".$i."],},";
								$i++;
							}
							?>
					        ...
					        symbolClip: true,
					        symbolBoundingData: bodyMax,
					        label: labelSetting2016,
					        data: 
					        [
					        <?php
						    $i=0;
							foreach($data2016["kelompokumur"] as $iname){
								echo "{value: ".$data2016["jml"][$i].",";
								echo "symbol: symbols[".$i."],},";
								$i++;
							}
							?>
				...
				var myChart = echarts.init(document.getElementById('picto5'));
				myChart.setOption(option);

				/*var myChart2 = echarts.init(document.getElementById('picto6'));
