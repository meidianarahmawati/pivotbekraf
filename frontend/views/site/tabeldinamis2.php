    ...
    <div class="body-content">
        ...
        <?php 
            ...
            echo '<div class="col-sm-8">'.Select2::widget([
                ...
                'options' => ['placeholder' => 'Pilih Dataset ...', 'onchange' => 'this.form.submit()', 'style' => 'width: 50%;display: inline-block', 'id' => 'tabel-id'],
            ]).'</div>';
            echo Html::endForm();
            ...
            echo '&nbsp;<button type="button" id="btn-custom-2" class="btn btn-info">Daftar Tabel</button>';
            echo '</div>';        
            ...
            Pjax::begin(['id' => 'pjax-grid-view','timeout' => 10000]);
...
//tooltip dalam dropdown
    $(document).ready(function(){
        ...
        /*$(".modal").find("input").each(function(){
            $(this).attr('onkeyup','return ignoreEnter(event);');
            $(this).attr('onkeydown','return ignoreEnter(event);');
        });*/
        $("#btn-custom-2").click(function(){            
            $(".modal .pagination").find("li").each(function(){
                $(this).on('click', function(ev) {
                     $.pjax.reload({container: '#pjax-grid-view'})
                });
            });
        });
        $("#pjax-grid-view").on("pjax:complete", function(){
            alert('pjax complete');
            $.pjax.reload({container: '#pjax-grid-view'})
        });
    });
